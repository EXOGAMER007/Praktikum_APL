...
int login2(int verifikasi, int perulangan){ //fungsi login
    ...
    if (perulangan == 2){ //jika melakukan perulangan lebih dari 3x maka program akan mati
        ...
        return login2(verifikasi, perulangan); //memanggil fungsi login2 untuk melakukan perulangan 
        }
}

void menu_utama(int jml, int idx, string menu, string champion[], string ulang){ //fungsi menu utama untuk menampilkan menu
    // Tampilkan menu
    while (ulang == "y"){ 
        cout<<"menu\n"
...
void variabel_menu(){
    ...
    menu_utama(jml, idx, menu, champion, ulang); //memanggil fungsi menu utama untuk menampilkan menu
}
...
int main(){
    ...
    login2(verifikasi, perulangan); //memanggil fungsi untuk login
